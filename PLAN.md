...
- `scripts/refresh_source.py --retry-failed` validates current ll-fans metadata, reuses compatible verified or explicitly unavailable wiki results, and retries stale, missing, ambiguous, unresolved, new, or changed songs.
