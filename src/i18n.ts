...
export const translations: Record<Language, UiText> = {
  ...
  ja: {
    ...
    appBlurb: "ラブライブ！の楽曲から、王道進行（IV–V–iii–vi など）が現れる節を探して聴けるカタログです。\n\n結果はコードの自動解析によるものです。コード名やローマ数字が正しくない場合や、出現節を見落としている場合があります。",
    matchingSongsMetric: "一致する楽曲",
    uniqueMomentsMetric: "一致節",
    ...
    playbackBlocked: "ブラウザーによって再生がブロックされました。音源コントロールからこの節を再生してください。",
    ...
    playingSelectedMoment: "選択した節を再生中",
    playingSong: "楽曲を再生中",
    audioReady: "音源の準備完了",
